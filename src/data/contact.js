const contactOptions = [
  ...
  {
    topic: 'Quero aparecer no Google!',
    helptext:
      'Apareça na maior rede de buscas online. Saiba tudo sobre o Google.',
    id: 'help-aparecer-buscas',
    links: [
      { href: 'http://entrecliques.com.br/gerador-google-meu-negocio/', name: 'Gerador de links de avaliação', id: 'help_item-gerador-avaliacao' },
      { href: 'http://entrecliques.com.br/perfil-google-meu-negocio/', name: 'Avaliação de Perfil Vendedor', id: 'help_item-avaliacao-perfil' },
    ],
  },
  {
    topic: 'Quero aprender a usar as mídias digitais!',
    helptext:
      'Passo a passo para você impulsionar o marketing digital da sua empresa. Vamos lá?',
